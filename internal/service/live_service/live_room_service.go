...
type LiveRoomService struct {
	liveRoomDao live_room.ILiveRoomDao
	log         *log.Helper
}

func NewLiveRoomService(logger log.Logger, liveRoomDao live_room.ILiveRoomDao) *LiveRoomService {
...
func (l *LiveRoomService) Add(ctx context.Context, params LiveRoomAddParams_) (lastId int, err error) {
	...
	var newData live_room.LiveRoom
...
func (l *LiveRoomService) Info(ctx context.Context, params LiveRoomInfoParams_) (info live_room.LiveRoom, err error) {
...
func (l *LiveRoomService) InfoById(ctx context.Context, liveRoomId int) (info live_room.LiveRoom, err error) {
...
func (l *LiveRoomService) List(ctx context.Context, params LiveRoomListParams_) (list []live_room.LiveRoom, total int64, err error) {
